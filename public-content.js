...
export const getRecordTitle = (record = {}, fallback = "Untitled") => { record = record || {}; return record.instituteName || record.title || record.name || record.opportunityName || fallback; };
