const fs = require('fs');
let content = fs.readFileSync('c:/dev/edupath_lanka/student-dashboard.js', 'utf8');

const oldImport = 'import { buildStudentRecommendationProfile as buildSharedRecommendationProfile, scoreCourseRecommendation, scoreScholarshipRecommendation, scoreMentorRecommendation, recommendCourses as sharedRecommendCourses, recommendScholarships as sharedRecommendScholarships, recommendMentors as sharedRecommendMentors, recommendInstitutes, recommendTalentOpportunities, debugStudentProfile } from "./recommendation-engine.js";';
const newImport = 'import { buildStudentRecommendationProfile, recommendCourses, recommendScholarships, recommendMentors, recommendInstitutes, recommendTalentOpportunities, debugStudentProfile } from "./recommendation-engine.js";';
content = content.replace(oldImport, newImport);

const oldRecalc = 'function recalculateStudentRecommendations({ updateCourses, updateScholarships, updateMentors }) {\n    if (updateCourses && typeof renderCourses === "function") renderCourses();\n    if (updateScholarships && typeof renderScholarships === "function") renderScholarships();\n    if (updateMentors && typeof renderMentors === "function") renderMentors();\n    if (typeof renderStudentOverview === "function") renderStudentOverview();\n    if (typeof scheduleRecommendationSave === "function") scheduleRecommendationSave();\n}';
const newRecalc = 'function recalculateStudentRecommendations({ updateCourses, updateScholarships, updateMentors }) {\n    if (typeof renderPersonalizedRecommendations === "function") renderPersonalizedRecommendations();\n    if (typeof renderStudentOverview === "function") renderStudentOverview();\n    if (typeof scheduleRecommendationSave === "function") scheduleRecommendationSave();\n}';
...
fs.writeFileSync('c:/dev/edupath_lanka/student-dashboard.js', content, 'utf8');
console.log('Successfully updated student-dashboard.js using Node.js!');
